...
import { batchLinkProductsToAddonGroupWorkflow } from "../../../../../workflows/batch-link-products-addon-group";
...
export const POST = async (
  ...
  const workflow = batchLinkProductsToAddonGroupWorkflow(req.scope);
  await workflow.run({
    input: {
      id,
      add,
